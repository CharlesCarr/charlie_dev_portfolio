...
function RightSection() {
  ...
  return (
    <main className="w-3/4 h-full flex flex-col border border-black p-6">
      <div className="flex justify-center items-end w-full h-16 border">
        <ul className="m-0 p-0 w-full flex justify-start items-end pl-5 pb-2">
          <li className={`${filterState === 'Latest Projects' ? 'border-b-2 border-black font-bold' : 'font-light'} mr-16 cursor-pointer`} onClick={(e: any) => setFilterState(e.target.innerText)}>Latest Projects</li>
          <li className={`${filterState === 'Skillset' ? 'border-b-2 border-black font-bold' : 'font-light'} mr-16 cursor-pointer`} onClick={(e: any) => setFilterState(e.target.innerText)}>Skillset</li>
          <li className={`${filterState === 'About' ? 'border-b-2 border-black font-bold' : 'font-light'} mr-16 cursor-pointer`} onClick={(e: any) => setFilterState(e.target.innerText)}>About</li>
        </ul>
      </div>

      <div className="w-full h-main mt-5 flex justify-around items-center border p-6">
