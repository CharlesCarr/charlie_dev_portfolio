...
const Footer = () => {
  return (
    <div className="w-full bg-black flex px-2 sm:px-10 lg:px-60 py-24 text-xs sm:text-sm">
      <div className="flex flex-col items-start w-1/2">
        <p className="text-base sm:text-xl mb-2">This Website</p>
      ...
      <div className="flex flex-col items-end w-1/2">
        <p className="text-base sm:text-xl mb-2">Contact</p>
